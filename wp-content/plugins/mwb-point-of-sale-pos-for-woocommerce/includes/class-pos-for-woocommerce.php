...
class Pos_For_Woocommerce {
	...
	private function mwb_pos_for_woocommerce_admin_hooks() {
		...
		// invoice generator.
		$this->loader->add_action( 'admin_init', $pfw_plugin_admin, 'mwb_pos_generate_order_invoice' );
	}
	...
	private function mwb_pos_for_woocommerce_public_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_mwb_pos_get_manager_orders', $pfw_plugin_public, 'mwb_pos_get_manager_orders' );
		$this->loader->add_action( 'wp_ajax_nopriv_mwb_pos_get_manager_orders', $pfw_plugin_public, 'mwb_pos_get_manager_orders' );

		// Check wallet enable.
		$this->loader->add_action( 'wp_ajax_mwb_pos_get_wallet_details', $pfw_plugin_public, 'mwb_pos_get_wallet_details' );
		$this->loader->add_action( 'wp_ajax_nopriv_mwb_pos_get_wallet_details', $pfw_plugin_public, 'mwb_pos_get_wallet_details' );

		// get reports for orders.
		$this->loader->add_action( 'wp_ajax_mwb_pos_collect_report', $pfw_plugin_public, 'mwb_pos_collect_report' );
		$this->loader->add_action( 'wp_ajax_nopriv_mwb_pos_collect_report', $pfw_plugin_public, 'mwb_pos_collect_report' );
		// hide admin bar for query monitor.
		$this->loader->add_action( 'qm/process', $pfw_plugin_public, 'mwb_pos_remove_admin_bar_query_moniter', 10, 2 );

		// hide mobile menu from pos for flatsome theme.
		$this->loader->add_action( 'wp', $pfw_plugin_public, 'mwb_pos_remove_mobile_menu_flatsome', 999);
	}
