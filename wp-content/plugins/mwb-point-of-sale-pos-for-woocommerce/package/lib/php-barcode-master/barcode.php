...
// $filepath = isset( $_GET['filepath'] ) ? sanitize_text_field( wp_unslash( $_GET['filepath'] ) ) : '';
// $text = isset( $_GET['text'] ) ? sanitize_text_field( wp_unslash( $_GET['text'] ) ) : '0';
// $size = isset( $_GET['size'] ) ? sanitize_text_field( wp_unslash( $_GET['size'] ) ) : '20';
// $orientation = isset( $_GET['orientation'] ) ? sanitize_text_field( wp_unslash( $_GET['orientation'] ) ) : 'horizontal';
// $code_type = isset( $_GET['codetype'] ) ? sanitize_text_field( wp_unslash( $_GET['codetype'] ) ) : 'code128';
// $print = isset( $_GET['print'] ) && ( 'true' == sanitize_text_field( wp_unslash( $_GET['print'] ) ) ) ? true : false;
// $sizefactor = isset( $_GET['sizefactor'] ) ? sanitize_text_field( wp_unslash( $_GET['sizefactor'] ) ) : '1';
