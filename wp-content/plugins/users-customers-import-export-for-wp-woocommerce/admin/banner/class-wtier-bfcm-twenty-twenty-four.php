 ...
 */
if (!class_exists('\\Wtieruser\\Banners\\Wtier_Bfcm_Twenty_Twenty_Four')) {
    ...
    class Wtier_Bfcm_Twenty_Twenty_Four
    {
        ...
        {
            self::$banner_version = WT_U_IEW_VERSION; // Plugin version
                    ...
                    <div class="wtier-bfcm-banner-body">
                        ...
                        <div class="wtier-bfcm-banner-body-info">
                            <div class="never-miss-this-deal">
                                <p><?php echo esc_html__('Never Miss This Deal', 'users-customers-import-export-for-wp-woocommerce'); ?></p>
                            </div>
                            <div class="info">
                                <p>
                                    <?php
                            ...
                            <div class="info-button">
                                <a href="<?php echo esc_url(self::$promotion_link); ?>" class="bfcm_cta_button" target="_blank"><?php echo esc_html__('View plugins', 'users-customers-import-export-for-wp-woocommerce'); ?> <span class="dashicons dashicons-arrow-right-alt"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
<?php
    ...
    new \wtieruser\Banners\Wtier_Bfcm_Twenty_Twenty_Four();
}
