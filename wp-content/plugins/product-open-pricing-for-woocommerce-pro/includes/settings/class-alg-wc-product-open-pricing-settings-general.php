	...
	public static function get_settings() {
		...
		$settings = array(
			...
			array(
				...
				'desc_tip' => 
					__( 'Product Open Pricing (Name Your Price) Pro', 'product-open-pricing-for-woocommerce' )
					. ' v' . WPWHAM_PRODUCT_OPEN_PRICING_PRO_VERSION . '.<br />'
					. '<a href="https://wpwham.com/documentation/product-open-pricing-name-your-price-for-woocommerce/?utm_source=documentation_link&utm_campaign=premium&utm_medium=product_open_pricing" target="_blank" class="button">' .
			...
			array(
				'title'    => __( 'License Key', 'product-open-pricing-for-woocommerce' ),
				'id'       => 'wpwham_product_open_pricing_license',
				'desc_tip' => __( 'Enter the license key from your purchase to enable updates and support.', 'product-open-pricing-for-woocommerce' ),
				'type'     => 'text',
				'desc'     => apply_filters(
					'wpwham_product_open_pricing_option_field',
					'<button name="save" class="button-primary woocommerce-save-button" type="submit" value="' . esc_attr( __( 'Save changes', 'woocommerce' ) ) . '">' .
						esc_html( __( 'Update', 'woocommerce' ) ) . '</button>'
				),
			),
			array(
				'type'     => 'sectionend',
