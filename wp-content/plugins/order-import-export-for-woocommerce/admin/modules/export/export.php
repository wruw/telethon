...
class Wt_Import_Export_For_Woo_Basic_Export
{
        ...
        public function __construct()
	{
		...
		/* The ad banner will be dismissed permenantly */
		add_action('wp_ajax_iew_export_dismiss_adbanner', array($this, 'iew_export_dismiss_adbanner'), 10);
		
	}

	
	/**
	 * 	Dismiss pro ad banner after export download
	 */
