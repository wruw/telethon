		...
		$this->tab_data = array(
			...
			'questions' => array(
				...
				$this->tab_help_question_response(
					...
					sprintf(__( 'Probably, there is a conflict with another plugin. <a href=%s target=_blank>Please, check javascript errors at first</a>.','phone-orders-for-woocommerce' ), 'https://codex.wordpress.org/Using_Your_Browser_to_Diagnose_JavaScript_Errors#Step_3:_Diagnosis')
				),
			),
		);
		?>
