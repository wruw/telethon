...
namespace Barn2\Plugin\WC_Product_Table\Dependencies\Lib\WooCommerce\Admin;

use Barn2\Plugin\WC_Product_Table\Dependencies\Lib\Admin\Abstract_Plugin_Promo;
use Barn2\Plugin\WC_Product_Table\Dependencies\Lib\Admin\Settings_Util;
use Barn2\Plugin\WC_Product_Table\Dependencies\Lib\Admin\Plugin_Promo as OG_Promo;
        ...
        if (!empty($promo_sidebar)) {
			...
			<p class="submit barn2-settings-submit">
				<button name="save" class="button-primary woocommerce-save-button" type="submit"
						value="<?php 
            esc_attr_e('Save changes', 'woocommerce-product-table');
            ?>"><?php 
            esc_html_e('Save changes', 'woocommerce-product-table');
            ?></button>
			</p>
